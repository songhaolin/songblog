...
<html lang="en">
<head>
    <#--    从zui官网的hello,world页面获取-->
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <#--    从zui官网源码页面内获取，用来引入网页图标-->
    <link rel="shortcut icon" href="./img/adminIndex.ico" type="image/x-icon">
    <link rel="icon" href="./img/adminIndex.ico" type="image/x-icon">
